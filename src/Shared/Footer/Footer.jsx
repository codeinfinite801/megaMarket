...
const Footer = () => {
    return (
        <div className="mt-10">
            ...
            {/* footer */}
            <div className="bg-white flex mt-10 px-2">
                <div className="grid lg:grid-cols-5 md:grid-cols-3 gap-4 gap-y-3 px-4">
                    <div className="mb-5">
                        <div>
                            <img className="w-[90px] h-[90px] mb-2" src="https://i.postimg.cc/Bn1xYC9C/417533939-1451020992427951-1786153557459718164-n-removebg-preview-1-removebg-preview.png" alt="" />
                        </div>
