...
const SignIn = () => {
  ...
  const { userSignIn, signInWithGoogle, logOut } = useAuth();
      ...
      <div className="w-[80%]  flex flex-col gap-10 lg:flex-row mx-auto">
        <div className=" flex-1 w-full ">
          <div className="text-center ">
            <h1 className=" text-xl font-semibold pt-20">
              Nice to see you again
            </h1>
            <p className=" text-6xl font-bold  py-3">Welcome Back</p>
            <div className="divider w-[30%] mx-auto"></div>
            <p className="text-xl font-normal">
              Welcome back, valued member! Your continued presence enriches our
              community. We appreciate your continued support and look forward
              to providing you with an exceptional experience on our website.
        ...
        <div className="flex-1 w-full">
          <div className="  w-[90%] pt-10 ">
            ...
            <div className="flex gap-2 items-center justify-center">
              <button onClick={handelWithGoogle}>
                <div className="border p-2 rounded-lg hover:bg-gray-100 flex items-center gap-2">
                  <img
                    className="w-[30px]"
                    src="https://www.pngall.com/wp-content/uploads/13/Google-Logo-PNG-Image.png"
                    alt=""
                  />
            ...
            <p className="text-center pt-6">
              New here? please{" "}
              <Link to="/signUp" className=" text-rose-400 font-bold underline">
                Sign Up
              </Link>
            </p>
          </div>
