                ...
                <Link to={`/kidsDetails/${_id}`}>
                    <div className="hover:shadow-lg hover:scale-105 transition-transform duration-300 hover:border-gray-400 rounded-md p-8 bg-white">
                        <div className="relative flex justify-center">
                            <img className="w-1/2 hover:opacity-90 transition-opacity duration-300" src={image[0]} alt="" />
                        ...
                        <h3 className="text-center text-gray-600 text-sm">{brand}</h3>
