              ...
              {categories.slice(0, 1).map((item, index) => (
                <div key={index} className="hover:transform hover:scale-105 transition-transform duration-300">
                  <Link to={`/allBooks/${item?.category}`} className="block">
                    <div className="bg-[#cc00ff21] flex flex-row-reverse md:items-center items-end lg:items-center justify-center lg:h-[420px] md:h-[255px] rounded-lg hover:shadow-lg">
            ...
            <div className="col-span-8 mx-2">
              <div className="lg:grid w-full md:grid grid-cols-2 lg:gap-10 md:gap-2 rounded lg:m-2">
                {categories.slice(1, 5).map((item, index) => (
                  <div key={index} className="hover:transform hover:scale-105 transition-transform duration-300">
                    <Link to={`/allBooks/${item?.category}`} className="block ">
                      <div className="bg-[#cc00ff21] rounded-lg  flex items-end hover:shadow-lg">
